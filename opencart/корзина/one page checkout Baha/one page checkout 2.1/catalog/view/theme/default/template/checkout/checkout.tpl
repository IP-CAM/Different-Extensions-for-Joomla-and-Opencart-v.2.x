...
<div class="container">        
		...
		<div class="row">
			<div class="col-md-12">
			    ...
			    <p class="well hide"><?php echo $text_returning_customer; ?> &nbsp;<a href="#" onclick="jQuery('.login-form').toggle();return false;"><?php echo $text_i_am_returning_customer; ?></a></p>
		...
		<div class="row box checkout_form">
			...
			<div class="row">
				  ...
				  <div class="form-group col-md-6 hide">
				    ...
				    <input type="text" name="lastname" value="null" placeholder="<?php echo str_replace(':','',$entry_lastname); ?>" id="input-payment-lastname" class="form-control" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
				  </div>
				  <div class="form-group col-md-12 hide">
				    <label class="control-label" for="input-payment-email"><?php echo $entry_email; ?></label>
				    <input type="text" name="email" value="null@mail.ru" placeholder="<?php echo str_replace(':','',$entry_email); ?>" id="input-payment-email" class="form-control" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
				  </div>
				  <div class="form-group required  col-md-6">
				  ...
				  <div class="form-group col-md-6 hide">
				    ...
				    <input type="text" name="fax" value="notfax" placeholder="<?php echo str_replace(':','',$entry_fax); ?>" id="input-payment-fax" class="form-control" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
				  </div>
				  <?php //}?>
			    ...
			    <?php if (isset($customer_id)) {?>	  
				  ...
				  <div class="form-group col-md-6 hide">
				    ...
				    <input type="text" name="company" value="company" placeholder="<?php echo str_replace(':','',$entry_company); ?>" id="input-payment-company" class="form-control" />
				  </div>
				   <?php //} else {?>
				  ...
				  <div class="form-group  col-md-6">
				    ...
				    <input type="text" name="address_1" value="" placeholder="Введите адрес" id="input-payment-address-1" class="form-control" />
				  </div>
				  <div class="form-group col-md-12 hide">
				    <label class="control-label" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
				    <input type="text" name="address_2" value="null" placeholder="<?php echo str_replace(':','',$entry_address_2); ?>" id="input-payment-address-2" class="form-control" />
				  </div>
				  <div class="form-group required col-md-6 hide">
				    <label class="control-label" for="input-payment-country"><?php echo $entry_country; ?></label>
				    <select name="country_id" id="input-payment-country" class="form-control">
				      <option value=""><?php echo $text_select; ?></option>
				      <?php foreach ($countries as $country) { ?>
				     <?php if ($country['country_id'] == 109) { ?>
				  ...
				  <div class="form-group col-md-6 hide">
				    ...
				    <input type="text" name="city" value="Астана" placeholder="<?php echo str_replace(':','',$entry_city); ?>" id="input-payment-city" class="form-control" />
				  </div>
				  <div class="form-group col-md-6 hide">
				    <label class="control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
				    <input type="text" name="postcode" value="010000" placeholder="<?php echo str_replace(':','',$entry_postcode); ?>" id="input-payment-postcode" class="form-control" />
				  </div>
				</div>
		    ...
		    <div class="col-md-6">
			<div class="shiptobilling clearfix hide">
			   ...
			   <?php //}?>
			    ...
			    <div class="shipping-method hide">
				...
				<div class="your_order">
		    		<h3 class="hide"><?php echo $text_cart;?></h3>
					    <table id="cart_table" class="table table-bordered table-hover table-responsive hide">
					      <thead>
						<tr>
					...
					<div class="radio">
					  <label>
					    ...
					    <input type="radio" class="tipes" name="payment_method" value="null" title="null" checked="checked" />
					    <?php } else { ?>
					    <input type="radio" class="tipes" name="payment_method" value="<?php echo $payment_method['code']; ?>" title="<?php echo $payment_method['title']; ?>" checked="checked" />
					    <?php } ?>
					...
					<div class="payment clearfix" style="margin-bottom:40px;">
					    <?php if ($payment) echo $payment; else {?>
					    <input type="button" class="btn btn-primary clikergung" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" id="button-register" value="Отправить заявку">
					    <?php }?></div>
					</div>
			    </div>
			</div>
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
        ...
        success: function(json) {
            ...
            $('select[name=\'zone_id\']').html(html).val("1716");
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
        }
...
$('select[name=\'shipping_country_id\']').on('change', function() {
	$.ajax({
        ...
        success: function(json) {
            ...
            $('select[name=\'shipping_zone_id\']').html(html).val("1716");
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
        }
...
{
	if (this.name == 'contry_id') jQuery("select[name=\'zone_id\']").val("1716");
	if (this.name == 'shipping_country_id') jQuery("select[name=\'shipping_zone_id\']").val("1716");
...
<script> 
jQuery(document).ready(function(){
jQuery("#input-payment-zone option[value="1720"]").attr("selected","selected");
});
</script> 